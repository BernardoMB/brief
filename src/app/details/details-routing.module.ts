...
const routes: Routes = [
  ...
  // Address (6)
  { path: 'address', component: MapComponent },
  { path: 'address/:source/:userdata/:campaignid/:industryid/:serviceid', component: MapComponent },
  // Coverage (7)
  { path: 'coverage', component: CoverageComponent },
  { path: 'coverage/states', component: SelectStatesComponent }
];
