...
import { SetLeadDataInfoAction } from '../../../store/actions/storeData.actions';
declare var $: any;

@Component({
  selector: 'brief-select-industry',
...
export class SelectIndustryComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.imgUrlModal = './../../../assets/images/svg/economic-activity/manufacture.svg';

    // Initilize view variables.
    this.title = '¿A qué industria pertenece tu servicio?';
    this.subtitle = '';
    this.imgUrlFixed = './../../../assets/images/svg/economic-activity/manufacture.svg';
